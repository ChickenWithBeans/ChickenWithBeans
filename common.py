...
def estimate_vmac(teff, logg, feh):
    ...
    The relation was constructed by Doyle et al. (2014) for dwarfs and by Maria Bergemann (for the Gaia ESO Survey) for giants
    Caution: The calibration by Doyle et al. (2014) is valid for the Teff range 5200 to 6400 K, and the log g range 4.0 to 4.6 dex.
    """
    #t0 = 5500
    #g0 = 4.0
    t0 = 5777
